...
| **CLI** | ✅ אמיתי | — | `lumen convert in.md out.docx` — טקסט(tex/rst/org/adoc/csv/json/ipynb↔md) **+ בינארי (docx/epub)**; הפלט מזוהה ע"י ה-OS כ-"Microsoft Word 2007+". 10 טסטים + smoke ✅. publish עדיין לא |
